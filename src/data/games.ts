...
export const CATEGORY_BAR_GAMES = [
  ...
  { name: "Overwatch 2", slug: "overwatch-2", key: "OVERWATCH2" },
  { name: "Rocket League", slug: "rocket-league", key: "ROCKETLEAGUE" },
  { name: "Apex Legends", slug: "apex-legends", key: "APEX" },
  { name: "MLBB", slug: "mlbb", key: "MLBB" },
  { name: "Rainbow Six", slug: "rainbow-six", key: "RAINBOWSIX" },
  { name: "PUBG", slug: "pubg", key: "PUBG" },
  { name: "EA FC", slug: "ea-fc", key: "EAFC" },
  { name: "Tekken 8", slug: "tekken-8", key: "TAKKEN8" },
  { name: "Street Fighter", slug: "street-fighter", key: "STREETFIGHTER" },
  { name: "Free Fire", slug: "free-fire", key: "FREEFIRE" },
  { name: "BGMI", slug: "bgmi", key: "BGMI" },
];
